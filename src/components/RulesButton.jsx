...
const RulesButton = (props) => {
    ...
    return (
        <div className=''>
            ...
            <button onClick={()=> modalDisplay()} className='text-[15px] text-white tracking-widest pl-10 pr-10 pt-3 pb-3 rounded-[10px] absolute bottom-[20px] right-[20px] max-sm:left-[29%] max-sm:right-[29%] max-sm:bottom-[110px] transition-all font-bold bg-[#ffffff1c] hover:bg-blue-300 hover:text-[hsl(214,47%,23%)]'>RULES</button>
        </div>
    );
}
